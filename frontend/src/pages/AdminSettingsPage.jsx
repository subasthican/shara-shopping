  ...
  return (
    <Card title="Store Profile">
      <div className="grid gap-5 md:grid-cols-2">
        <Field label="Store Name" value="Shara Shopping" />
        <Field label="Support Email" value="support@sharashopping.lk" />
        <Field label="Phone Number" value="+94 77 123 4567" />
        <Field label="WhatsApp Number" value="+94 77 123 4567" />
      </div>
      <label className="block">
        <span className="form-label">Store Address</span>
        <textarea className="form-control mt-2 min-h-24 py-3" defaultValue="Colombo, Sri Lanka" />
      </label>
    </Card>
  );
}
...
function SecuritySettings() {
  return (
    <Card title="Security">
      ...
      <button className="mt-2 inline-flex h-11 items-center gap-2 rounded border border-[#ded3c9] bg-white px-5 font-semibold">
        <KeyRound size={17} /> Rotate Secret Key
      </button>
    </Card>
  );
}
